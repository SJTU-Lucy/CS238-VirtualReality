...
parser.add_argument('--style_img_file', type=str, default='images/da_vinci.jpg', help='Style image file')
...
num_strokes = [10000, 5000, 15000][2]
optimizer_choice = ['Adam', 'RMSProp'][0]
decreasing_learning_rate = None  # 'None' if not used
shape_lr = [1e-3, 1e-3, 1e-3][2]
color_lr = [1e-2, 1e-2, 1e-2][2]
dist_index = 1


# 笔画的风格化
def run_stroke_style_transfer(num_steps=1, style_weight=5., content_weight=3., feature_weight=20,
...
# 像素级优化
def run_style_transfer(input_img: T.Tensor, num_steps=0, style_weight=10000., feature_weight=200, content_weight=10.,
                       tv_weight=0):
